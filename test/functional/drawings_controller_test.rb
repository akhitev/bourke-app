...
class DrawingsControllerTest < ActionController::TestCase
  ...
  test "should create drawing" do
    assert_difference('Drawing.count') do
      post :create, drawing: { drawing: @drawing.drawing, location: @drawing.location, project: @drawing.project }
    end
  ...
  test "should update drawing" do
    put :update, id: @drawing, drawing: { drawing: @drawing.drawing, location: @drawing.location, project: @drawing.project }
    assert_redirected_to drawing_path(assigns(:drawing))
  end
